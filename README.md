...
python train.py \
    ...
    --checkpoint_dir save_models/feature_4/QM9_atomic \
...
python train.py \
    ...
    --separate_test_path heat_formation_data/new_CCSD_exp/size_split/CCSD_exp_size_test_12.csv \
    --dataset_type regression \
    --checkpoint_dir save_models/feature_4/multi/multi_mfp_sum_PReLU/mfp_sum_6 \
...
python train.py \
    ...
    --separate_test_path heat_formation_data/new_CCSD_exp/size_split/CCSD_exp_size_test_12.csv \
    --dataset_type regression \
    --checkpoint_dir save_models/feature_4/multi/multi_"$METHOD"_"$ACTIVATION"/"$METHOD"_$FOLD \
    --save_dir save_models/feature_4/multi/multi_"$METHOD"_"$ACTIVATION"_transfer_newLR_gpu/"$METHOD"_$FOLD \
    --warmup_epochs 0 --max_lr 5e-4 --init_lr 1e-4 \
    --epochs 20 --final_lr 1e-5 --no_features_scaling \
    --dropout $DROPOUT --hidden_size 400 --ffn_num_layers 3 \
...
| :---: | :---: | :---: | :---: | :---: |
QM8 | 21,786 | MAE | 0.011 กำ 0.000 | 0.0143 กำ 0.0011 |
QM9 | 133,885 | MAE | 2.666 กำ 0.006 | 2.4 กำ 1.1 |
ESOL | 1,128 | RMSE | 0.555 กำ 0.047 | 0.58 กำ 0.03 |
FreeSolv | 642 | RMSE | 1.075 กำ 0.054 | 1.15 กำ 0.12 |
Lipophilicity | 4,200 | RMSE | 0.555 กำ 0.023 | 0.655 กำ 0.036 |
PDBbind (full) | 9,880 | RMSE | 1.391 กำ 0.012 | 1.25 กำ 0 | 
PDBbind (core) | 168 | RMSE | 2.173 กำ 0.090 | 1.92 กำ 0.07 | 
PDBbind (refined) | 3,040 | RMSE | 1.486 กำ 0.026 | 1.38 กำ 0 | 

Results on classification datasets (higher is better)

| Dataset | Size | Metric | Ours | MolNet Best Model |
| :---: | :---: | :---: | :---: | :---: |
| PCBA | 437,928 | PRC-AUC | 0.335 กำ 0.001 |  0.136 กำ 0.004 |
| MUV | 93,087 | PRC-AUC | 0.041 กำ 0.007 | 0.184 กำ 0.02 |
| HIV | 41,127 | ROC-AUC | 0.776 กำ 0.007 | 0.792 กำ 0 |
| BBBP | 2,039 | ROC-AUC | 0.737 กำ 0.001 | 0.729 กำ 0 |
| Tox21 | 7,831 | ROC-AUC | 0.851 กำ 0.002 | 0.829 กำ 0.006 |
| SIDER | 1,427 | ROC-AUC | 0.676 กำ 0.014 | 0.648 กำ 0.009 |
| ClinTox | 1,478 | ROC-AUC | 0.864 กำ 0.017 | 0.832 กำ 0.037 |
